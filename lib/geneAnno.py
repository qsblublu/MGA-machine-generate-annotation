...
encoder.load_state_dict(torch.load('D:\\code\\py\\machine_learning\\annotation_demo\\annotation_encoder.pth', map_location=config.eval_device))
decoder.load_state_dict(torch.load('D:\\code\\py\\machine_learning\\annotation_demo\\annotation_decoder.pth', map_location=config.eval_device))
